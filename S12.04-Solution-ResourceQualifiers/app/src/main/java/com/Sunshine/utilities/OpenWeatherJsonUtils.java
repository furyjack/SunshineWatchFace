...
//        long normalizedUtcStartDay = SunshineDateUtils.normalizeDate(now);
        ...
        long normalizedUtcStartDay = com.Sunshine.utilities.SunshineDateUtils.getNormalizedUtcDateForToday();
        ...
        for (int i = 0; i < jsonWeatherArray.length(); i++) {
             ...
             */
            dateTimeMillis = normalizedUtcStartDay + com.Sunshine.utilities.SunshineDateUtils.DAY_IN_MILLIS * i;
