...
public class NotificationUtils {
    ...
    public static void notifyUserOfNewWeather(Context context) {
        ...
        Uri todaysWeatherUri = WeatherContract.WeatherEntry
                .buildWeatherUriWithDate(com.Sunshine.utilities.SunshineDateUtils.normalizeDate(System.currentTimeMillis()));
        ...
        if (todayWeatherCursor.moveToFirst()) {
            ...
            int largeArtResourceId = com.Sunshine.utilities.SunshineWeatherUtils
            ...
            int smallArtResourceId = com.Sunshine.utilities.SunshineWeatherUtils
    ...
    private static String getNotificationText(Context context, int weatherId, double high, double low) {
         ...
         */
        String shortDescription = com.Sunshine.utilities.SunshineWeatherUtils
        ...
        String notificationText = String.format(notificationFormat,
                shortDescription,
                com.Sunshine.utilities.SunshineWeatherUtils.formatTemperature(context, high),
               com.Sunshine.utilities.SunshineWeatherUtils.formatTemperature(context, low));
