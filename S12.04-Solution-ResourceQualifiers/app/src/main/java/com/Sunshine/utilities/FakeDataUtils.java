...
import static com.Sunshine.data.WeatherContract.WeatherEntry;
...
public class FakeDataUtils {
    ...
    public static void insertFakeData(Context context) {
        ...
        long today = com.Sunshine.utilities.SunshineDateUtils.normalizeDate(System.currentTimeMillis());
