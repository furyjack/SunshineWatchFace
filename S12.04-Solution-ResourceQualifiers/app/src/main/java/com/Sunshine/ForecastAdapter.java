...
class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
        ...
        switch (viewType) {
            ...
            case VIEW_TYPE_TODAY:
                weatherImageId = com.Sunshine.utilities.SunshineWeatherUtils
         ...
         * Weather Description *
         ***********************/
        String description = com.Sunshine.utilities.SunshineWeatherUtils.getStringForWeatherCondition(mContext, weatherId);
        ...
        double highInCelsius = mCursor.getDouble(MainActivity.INDEX_WEATHER_MAX_TEMP);
          ...
          * String.
          */
        String highString = com.Sunshine.utilities.SunshineWeatherUtils.formatTemperature(mContext, highInCelsius);
         /* Create the accessibility (a11y) String from the weather description */
        ...
        double lowInCelsius = mCursor.getDouble(MainActivity.INDEX_WEATHER_MIN_TEMP);
          ...
          * String.
          */
        String lowString = com.Sunshine.utilities.SunshineWeatherUtils.formatTemperature(mContext, lowInCelsius);
